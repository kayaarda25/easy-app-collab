  ...
  return (
    <div className="min-h-screen bg-background px-6 py-12">
      <div className="mx-auto max-w-md">
        <p className="text-sm text-primary font-semibold">{t("Step 1 of 2")}</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight">{t("Tell us about yourself")}</h1>
        <p className="mt-2 text-sm text-muted-foreground">{t("This helps other members get to know you.")}</p>
        ...
        <form onSubmit={submit} className="mt-8 space-y-4">
          <div className="flex flex-col items-center gap-2 pb-2">
            ...
            <p className="text-xs text-muted-foreground">
              {avatarUrl ? t("Tap to change") : t("Add a profile photo (optional)")}
            </p>
          </div>
